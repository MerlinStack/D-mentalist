...
const BOOK_ALIASES = {
  ...
  jdg:'Judges', judges:'Judges', judg:'Judges', jg:'Judges',
  rut:'Ruth', ruth:'Ruth', ru:'Ruth',
  '1sa':'1 Samuel', '1 samuel':'1 Samuel', 'i samuel':'1 Samuel',
  '2sa':'2 Samuel', '2 samuel':'2 Samuel', 'ii samuel':'2 Samuel',
  '1ki':'1 Kings', '1 kings':'1 Kings', 'i kings':'1 Kings',
  '2ki':'2 Kings', '2 kings':'2 Kings', 'ii kings':'2 Kings',
  '1ch':'1 Chronicles', '1 chronicles':'1 Chronicles', 'i chronicles':'1 Chronicles',
  '2ch':'2 Chronicles', '2 chronicles':'2 Chronicles', 'ii chronicles':'2 Chronicles',
  ezr:'Ezra', ezra:'Ezra',
  neh:'Nehemiah', nehemiah:'Nehemiah',
  est:'Esther', esther:'Esther',
  job:'Job',
  psa:'Psalms', psalm:'Psalms', psalms:'Psalms', ps:'Psalms', psl:'Psalms',
  pro:'Proverbs', proverbs:'Proverbs', prov:'Proverbs', pr:'Proverbs',
  ecc:'Ecclesiastes', ecclesiastes:'Ecclesiastes', eccl:'Ecclesiastes',
  sng:'Song of Solomon', 'song of solomon':'Song of Solomon', song:'Song of Solomon',
  isa:'Isaiah', isaiah:'Isaiah', is:'Isaiah',
  jer:'Jeremiah', jeremiah:'Jeremiah', jr:'Jeremiah', jrm:'Jeremiah',
  ...
  jol:'Joel', joel:'Joel', jl:'Joel',
  amo:'Amos', amos:'Amos', am:'Amos',
  oba:'Obadiah', obadiah:'Obadiah', ob:'Obadiah',
  jon:'Jonah', jonah:'Jonah', jnh:'Jonah',
  mic:'Micah', micah:'Micah', mc:'Micah',
  nam:'Nahum', nahum:'Nahum', na:'Nahum',
  ...
  zec:'Zechariah', zechariah:'Zechariah', zch:'Zechariah', zc:'Zechariah',
  ...
  jhn:'John', john:'John', jn:'John', joh:'John',
  act:'Acts', acts:'Act', ac:'Acts',
  rom:'Romans', romans:'Romans', ro:'Romans', rm:'Romans',
  '1co':'1 Corinthians', '1 corinthians':'1 Corinthians', 'i corinthians':'1 Corinthians',
  '2co':'2 Corinthians', '2 corinthians':'2 Corinthians', 'ii corinthians':'2 Corinthians',
  gal:'Galatians', galatians:'Galatians', ga:'Galatians',
  eph:'Ephesians', ephesians:'Ephesians', ep:'Ephesians',
  php:'Philippians', philippians:'Philippians', phi:'Philippians', pp:'Philippians',
  col:'Colossians', colossians:'Colossians', co:'Colossians',
  '1th':'1 Thessalonians', '1 thessalonians':'1 Thessalonians', 'i thessalonians':'1 Thessalonians',
  '2th':'2 Thessalonians', '2 thessalonians':'2 Thessalonians', 'ii thessalonians':'2 Thessalonians',
  '1ti':'1 Timothy', '1 timothy':'1 Timothy', 'i timothy':'1 Timothy',
  '2ti':'2 Timothy', '2 timothy':'2 Timothy', 'ii timothy':'2 Timothy',
  tit:'Titus', titus:'Titus', tt:'Titus',
  phm:'Philemon', philemon:'Philemon',
  heb:'Hebrews', hebrews:'Hebrews', hb:'Hebrews',
  jam:'James', james:'James', jm:'James',
  '1pe':'1 Peter', '1 peter':'1 Peter', 'i peter':'1 Peter',
  '2pe':'2 Peter', '2 peter':'2 Peter', 'ii peter':'2 Peter',
...
export function parseScriptureReference(text) {
  ...
  while ((m = standardRe.exec(text)) !== null) {
    ...
    if (book) {
      addMatch(m[0], m.index, m.index + m[0].length, book,
        parseInt(m[2]), parseInt(m[3]), m[4] ? parseInt(m[4]) : undefined)
    }
  }

  // Pattern 2: "Book chapter N verse M" or "Book chapter N verses M-M2"
  const spokenRe = /(\d{0,2}\s?[A-Za-z]+)\s+chapter\s+(\d+)\s+verse[s]?\s+(\d+)(?:\s*[-–]\s*(\d+))?/gi
  ...
  while ((m = chapRe.exec(text)) !== null) {
    ...
    if (book) {
      addMatch(m[0], m.index, m.index + m[0].length, book,
        parseInt(m[2]), undefined, undefined)
    }
  }
